...
#include <gst/skbmpegts/mpegts.h>
...
/* arun.s to get last pcr offset to set correct time duration */
G_GNUC_INTERNAL guint64 mpegts_packetizer_get_last_pcr (MpegTSPacketizer2 *
    packetizer);
